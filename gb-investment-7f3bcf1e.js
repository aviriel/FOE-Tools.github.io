...
$_mod_foe_tools.installed("foe-tools$1.3.3","marko","4.7.4");
...
$_mod_foe_tools.main("/foe-tools$1.3.3/src/routes/gb-investment","index.marko");
...
$_mod_foe_tools.def("/foe-tools$1.3.3/src/components/gb-investment/components/gb-list-select/index.marko", function(require, exports, module, __filename, __dirname) { // Compiled using marko@4.7.4 - DO NOT EDIT
"use strict";
...
var marko_template = module.exports = require('/marko$4.7.4/dist/vdom'/*"marko/dist/vdom"*/).t(),
    ...
    marko_componentType = marko_registerComponent("/foe-tools$1.3.3/src/components/gb-investment/components/gb-list-select/index.marko", function() {
      return module.exports;
    }),
    marko_component = require('/foe-tools$1.3.3/src/components/gb-investment/components/gb-list-select/component'/*"./component"*/),
...
$_mod_foe_tools.def("/foe-tools$1.3.3/src/components/gb-investment/index.marko", function(require, exports, module, __filename, __dirname) { // Compiled using marko@4.7.4 - DO NOT EDIT
"use strict";

var marko_template = module.exports = require('/marko$4.7.4/dist/vdom'/*"marko/dist/vdom"*/).t(),
    components_helpers = require('/marko$4.7.4/dist/components/helpers-browser'/*"marko/dist/components/helpers"*/),
    marko_registerComponent = components_helpers.rc,
    marko_componentType = marko_registerComponent("/foe-tools$1.3.3/src/components/gb-investment/index.marko", function() {
      return module.exports;
    }),
    marko_component = require('/foe-tools$1.3.3/src/components/gb-investment/component'/*"./component"*/),
    marko_renderer = components_helpers.r,
    marko_defineComponent = components_helpers.c,
    gb_list_select_template = require('/foe-tools$1.3.3/src/components/gb-investment/components/gb-list-select/index.marko'/*"./components/gb-list-select"*/),
    marko_helpers = require('/marko$4.7.4/dist/runtime/vdom/helpers'/*"marko/dist/runtime/vdom/helpers"*/),
    marko_loadTag = marko_helpers.t,
    gb_list_select_tag = marko_loadTag(gb_list_select_template),
    marko_str = marko_helpers.s,
    marko_forEachProp = require('/marko$4.7.4/dist/runtime/helper-forEachProperty'/*"marko/dist/runtime/helper-forEachProperty"*/),
    secure_position_template = require('/foe-tools$1.3.3/src/components/secure-position/index.marko'/*"../secure-position"*/),
...
$_mod_foe_tools.installed("foe-tools$1.3.3","lasso","2.11.23");
...
$_mod_foe_tools.installed("foe-tools$1.3.3","marko-magic","1.0.0");
...
$_mod_foe_tools.def("/foe-tools$1.3.3/src/components/site-layout/favicon.png",{url:"/favicon-38fce9d3.png",width:16,height:16});
$_mod_foe_tools.def("/foe-tools$1.3.3/src/components/site-layout/logo.png",{url:"/logo-256f79d2.png",width:744,height:838});
$_mod_foe_tools.def("/foe-tools$1.3.3/src/components/site-layout/index.marko", function(require, exports, module, __filename, __dirname) { // Compiled using marko@4.7.4 - DO NOT EDIT
"use strict";

var marko_template = module.exports = require('/marko$4.7.4/dist/vdom'/*"marko/dist/vdom"*/).t(),
    components_helpers = require('/marko$4.7.4/dist/components/helpers-browser'/*"marko/dist/components/helpers"*/),
    marko_registerComponent = components_helpers.rc,
    marko_componentType = marko_registerComponent("/foe-tools$1.3.3/src/components/site-layout/index.marko", function() {
      return module.exports;
    }),
    marko_component = require('/foe-tools$1.3.3/src/components/site-layout/component'/*"./component"*/),
    marko_renderer = components_helpers.r,
    marko_defineComponent = components_helpers.c,
    module_i18next_module = require('/foe-tools$1.3.3/src/services/i18next'/*"~/src/services/i18next"*/),
    ...
    language_selector_template = require('/foe-tools$1.3.3/src/components/site-layout/components/language-selector/index.marko'/*"./components/language-selector"*/),
...
function render(input, out, __component, component, state) {
  ...
  asset_var_tag({
      values: [
          require.resolve('/foe-tools$1.3.3/src/components/site-layout/favicon.png'/*"./favicon.png"*/)
        ],
  ...
  asset_var_tag({
      values: [
          require.resolve('/foe-tools$1.3.3/src/components/site-layout/logo.png'/*"./logo.png"*/)
        ],
...
$_mod_foe_tools.def("/foe-tools$1.3.3/src/routes/gb-investment/index.marko", function(require, exports, module, __filename, __dirname) { // Compiled using marko@4.7.4 - DO NOT EDIT
"use strict";

var marko_template = module.exports = require('/marko$4.7.4/dist/vdom'/*"marko/dist/vdom"*/).t(),
    components_helpers = require('/marko$4.7.4/dist/components/helpers-browser'/*"marko/dist/components/helpers"*/),
    marko_registerComponent = components_helpers.rc,
    marko_componentType = marko_registerComponent("/foe-tools$1.3.3/src/routes/gb-investment/index.marko", function() {
      return module.exports;
    }),
    marko_component = require('/foe-tools$1.3.3/src/routes/gb-investment/component'/*"./component"*/),
    marko_renderer = components_helpers.r,
    marko_defineComponent = components_helpers.c,
    gb_investment_template = require('/foe-tools$1.3.3/src/components/gb-investment/index.marko'/*"../../components/gb-investment"*/),
    marko_helpers = require('/marko$4.7.4/dist/runtime/vdom/helpers'/*"marko/dist/runtime/vdom/helpers"*/),
    marko_loadTag = marko_helpers.t,
    gb_investment_tag = marko_loadTag(gb_investment_template),
    site_layout_template = require('/foe-tools$1.3.3/src/components/site-layout/index.marko'/*"../../components/site-layout"*/),
