...
$_mod_foe_tools.main("/foe-tools$1.4.0/src/routes/secure-position","index.marko");
...
$_mod_foe_tools.def("/foe-tools$1.4.0/src/routes/secure-position/component",function(o,e,s,t,c){"use strict"});
...
$_mod_foe_tools.def("/foe-tools$1.4.0/src/routes/secure-position/index.marko", function(require, exports, module, __filename, __dirname) { // Compiled using marko@4.7.4 - DO NOT EDIT
"use strict";

var marko_template = module.exports = require('/marko$4.7.4/dist/vdom'/*"marko/dist/vdom"*/).t(),
    components_helpers = require('/marko$4.7.4/dist/components/helpers-browser'/*"marko/dist/components/helpers"*/),
    marko_registerComponent = components_helpers.rc,
    marko_componentType = marko_registerComponent("/foe-tools$1.4.0/src/routes/secure-position/index.marko", function() {
      return module.exports;
    }),
    marko_component = require('/foe-tools$1.4.0/src/routes/secure-position/component'/*"./component"*/),
    marko_renderer = components_helpers.r,
    marko_defineComponent = components_helpers.c,
    secure_position_template = require('/foe-tools$1.4.0/src/components/secure-position/index.marko'/*"../../components/secure-position"*/),
    marko_helpers = require('/marko$4.7.4/dist/runtime/vdom/helpers'/*"marko/dist/runtime/vdom/helpers"*/),
    marko_loadTag = marko_helpers.t,
